...
; Paste this ONCE at the end of Machine end G-code
; ================================================

M104 S0             ; Hotend off
M140 S0             ; Bed off
M106 S128           ; Fans at 50% for cooling

M117 FarmFlow: Cooling ${mins} min...
G4 S${secs}         ; Wait ${mins} minutes

M106 S0             ; Fans off

M117 FarmFlow: Ejecting!
G90
G1 X${cx} F9000     ; Center X
G1 Z${z} F600       ; Lower to 1mm above plate
G1 Y0 F9000         ; Move behind object
G1 Y${maxY} F2000   ; Sweep forward — eject!
  ...
  return (
    <div className={styles.wrap}>
      <div className={styles.header}>
        ...
        <p className={styles.sub}>Configure your printer once, paste the code into Bambu Studio, and every print — no matter what you're printing — ejects automatically when done. You never have to stand next to your printer again.</p>
      </div>
        ...
        <div className={styles.resultCard}>
          <div className={styles.resultHead}>
            <div>
              ...
              <div className={styles.resultSub}>Paste at the end of Machine end G-code in Bambu Studio — done forever</div>
            </div>
          ...
          <div className={styles.installGuide}>
            ...
            <ol className={styles.installSteps}>
              ...
              <li>Click <strong>Save</strong> — from now on every print auto-ejects, no matter what you print ✓</li>
            </ol>
          </div>
        </div>
      )}
