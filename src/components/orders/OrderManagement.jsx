...
const css = {
  ...
  textarea: { padding: '10px 12px', background: 'var(--surface2)', border: '1px solid var(--border)', borderRadius: '8px', fontSize: '14px', color: 'var(--text)', outline: 'none', width: '100%', fontFamily: 'var(--font)', resize: 'vertical', minHeight: '72px' },
  ...
  btnGreen: { padding: '5px 10px', background: 'transparent', border: '1px solid #3B6D11', borderRadius: '6px', fontSize: '12px', cursor: 'pointer', color: '#3B6D11', fontFamily: 'var(--font)' },
  btnBlue: { padding: '5px 10px', background: 'transparent', border: '1px solid #185FA5', borderRadius: '6px', fontSize: '12px', cursor: 'pointer', color: '#185FA5', fontFamily: 'var(--font)' },
  ...
  btnPurple: { padding: '5px 10px', background: 'transparent', border: '1px solid #7c3aed', borderRadius: '6px', fontSize: '12px', cursor: 'pointer', color: '#7c3aed', fontFamily: 'var(--font)' },
  ...
  shipCard: { background: 'var(--white)', border: '1px solid var(--border)', borderRadius: '12px', padding: '16px', marginBottom: '12px' },
