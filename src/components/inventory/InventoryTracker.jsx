...
const css = {
  ...
  g4: { display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(110px, 1fr))', gap: '12px', marginBottom: '12px' },
  g5: { display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(120px, 1fr))', gap: '12px', marginBottom: '12px' },
  ...
  btnOrder: { padding: '6px 12px', background: '#FAEEDA', border: '1px solid #FAC775', borderRadius: '6px', fontSize: '13px', cursor: 'pointer', color: '#854F0B', fontFamily: 'var(--font)' },
  ...
  spoolCard: { background: 'var(--white)', border: '1px solid var(--border)', borderRadius: '12px', padding: 'clamp(12px, 3vw, 16px)', marginBottom: '10px' },
  orderItem: (done) => ({ display: 'flex', alignItems: 'center', gap: '10px', padding: '12px 0', borderBottom: '1px solid var(--border)', opacity: done ? 0.5 : 1, flexWrap: 'wrap' }),
}
